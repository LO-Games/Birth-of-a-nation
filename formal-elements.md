...
<a href="https://en.wikipedia.org/wiki/Call_of_Duty_2">בקרו בעמוד המשחק בויקיפדיה.</a>
 ...
 <h3 dir='rtl'>Battlefield</h3>
 
משחק המחשב "Battlefield" הוא משחק פעולה-מלחמה רב-שחקן המתרחש בעולם פתוח.  
המשחק מתמקד בקרבות עכשוויים והיסטוריים, המתפרקים לכמה מצבי משימות משתנים עם מטרה להשתלט על כלי נשק, מבנים וזירות קרב מסוימות על מפת המשחק.  
השחקן יכול לבחור לשחק עם מגוון רחב של תפקידים כמו חייל, טנקיסט, טייס ועוד.  
המשחק מציע גם מצב לשחקנים להתחרות זה בזה ומצב רשת למציאת משחקים ושחקנים אחרים מכל העולם.  

<a href="https://www.ea.com/games/battlefield">בקרו בעמוד המשחק.</a>
 
 ![image](https://www.notebookcheck.net/fileadmin/_processed_/b/5/csm_Screenshot_2021_08_13_120805_0_99ef3ffa91.png)
 
 <h3 dir='rtl'>Assassin's Creed</h3>
 
משחק ה-Assassin's Creed הוא משחק פעולה-הרפתקאות המתרחש בעולם פתוח גדול ובו השחקן משחק בתפקיד של אסאסין שמתכוון לבצע משימות וכדי להשגת המטרה שלו יהיה עליו לשחק ולבצע משימות מסוימות שתערב בהן דמויות היסטוריות מהעולם האמיתי.  
המשחק כולל כמה גרסאות וחלקן מתרחשות בתקופות היסטוריות שונות, כגון ימי הביניים, עידן הרנסנס, וגם ימי המהפכה האמריקנית.  

<a href="https://www.ubisoft.com/en-us/game/assassins-creed">בקרו בעמוד המשחק.</a>
 
 ![image](https://i.pinimg.com/originals/19/89/32/198932a34342c756c7b82fb9cc05533e.jpg)

ההבדל המרכזי בין משחקים אלו למשחק שלנו יהיו מבחינת התוכן הינו אותו המשחק מעביר כיום לא קיימים משחקים בסגנון זה המעבירים את התוכן על מלחמת העצמאות והקמתה של מדינת ישראל.  
המשחקיות במשחק שלנו תהיה פשוטה ומתאימה לכל שחקן לעומת המשחקיות במשחקים אלה אשר מצריכה לעיתים רמת משחקיות גבוהה מצד השחקן.  
